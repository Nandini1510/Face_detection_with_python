...
face_cascade = cv2.CascadeClassifier('haarcascade_frontalface_default.xml') # loading haarcascade for the face.
eye_cascade = cv2.CascadeClassifier('haarcascade_eye.xml') # loading haarcascade for the eyes.
